...
interface ActivityRepository : JpaRepository<ActivityEntity, Long> {
    fun findByCode(code: String): ActivityEntity?

    @Query("SELECT a FROM ActivityEntity a WHERE a.keyWord = :keyWord")
    fun getActivityByKeyWord(keyWord: String): ActivityEntity?
